...
<div className=" bg-white rounded-2xl shadow-sm hover:shadow-md transition-all p-6 w-1/2  text-center border border-gray-100 mt-4">
      {/* Icon */}
      ...
      {/* Button */}
      <button onClick={()=>navigate("/demoReport")} className="w-full bg-blue-600 text-white font-medium py-2.5 rounded-lg hover:bg-blue-700 transition">
        Open Filter
      </button>
    </div>
